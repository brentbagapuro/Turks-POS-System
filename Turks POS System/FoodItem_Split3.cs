...
{
    public partial class FoodItem_Split3 : UserControl
    {
        public FoodItem_Split3()
        {
            InitializeComponent();
            this.Load += FoodItem_Split3_Load;
        }

        public event EventHandler<EventArgs> WasClicked;

        private void FoodItem_Split3_Load(object sender, EventArgs e)
        {
