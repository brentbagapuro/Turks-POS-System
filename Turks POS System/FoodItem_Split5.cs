...
{
    public partial class FoodItem_Split5 : UserControl
    {
        public FoodItem_Split5()
        {
            InitializeComponent();
            this.Load += FoodItem_Split5_Load;
        }

        public event EventHandler<EventArgs> WasClicked;

        private void FoodItem_Split5_Load(object sender, EventArgs e)
        {
