...
{
    public partial class FoodItem_Split4 : UserControl
    {
        public FoodItem_Split4()
        {
            InitializeComponent();
            this.Load += FoodItem_Split4_Load;
        }

        public event EventHandler<EventArgs> WasClicked;

        private void FoodItem_Split4_Load(object sender, EventArgs e)
        {
