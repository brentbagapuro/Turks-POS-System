...
{
    public partial class FoodItem_Split2 : UserControl
    {
        public FoodItem_Split2()
        {
            InitializeComponent();
            this.Load += FoodItem_Split2_Load;
        }

        public event EventHandler<EventArgs> WasClicked;

        private void FoodItem_Split2_Load(object sender, EventArgs e)
        {
